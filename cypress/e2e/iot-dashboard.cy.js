...
describe("Form without Labels", () => {
  ...
  it("Should display Form without Labels elements", () => {
    cy.contains("nb-card", "Form without labels").within(() => {
      cy.get("nb-card-header").should("have.text", "Form without labels");

      cy.get('input[placeholder="Recipients"]').should(
        "have.attr",
        "placeholder",
        "Recipients",
      );
      ...
      cy.get('textarea[placeholder="Message"]').should(
        "have.attr",
        "placeholder",
        "Message",
      );
  ...
  it("Should allow user to fill Form without Labels", () => {
    cy.get('input[placeholder="Recipients"]')
      .type("Abcdf")
      .should("have.value", "Abcdf");

    cy.get('input[placeholder="Subject"]')
      .type("QWERTYASDFGH")
      .should("have.value", "QWERTYASDFGH");

    cy.get('textarea[placeholder="Message"]')
      .type("POIUYTREWQ")
      .should("have.value", "POIUYTREWQ");
  });

  it("Should submit Form without Labels", () => {
    cy.get('input[placeholder="Recipients"]').type("QWERTYASDFGHZXCVB");
    cy.get('input[placeholder="Subject"]').type("POIpoiPOI");

    cy.get('textarea[placeholder="Message"]').type("POIUYTREWQ");
    ...
    cy.get('input[placeholder="Subject"]').should("have.value", "POIpoiPOI");
